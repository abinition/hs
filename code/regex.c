...
#if defined(__ALPHA) || defined(__ia64) || (__DECC_VER >= 60000000)
#include <builtins.h>
...
/*
 * Allow implementations to confine the scope of re_max_failures.
 * If the ability to reference this externally then access
 * routines may be a better way to support this.
 */
#ifndef SCOPE_RE_MAX_FAILURES
#define SCOPE_RE_MAX_FAILURES
#endif
...
#define FREE_STACK_RETURN(value)		\
  return (ReleaseMemory (compile_stack.stack), value)
