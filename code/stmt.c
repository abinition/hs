 ...
 *	Version 3.3.0
 *	
 *	Revision 1.8  2004/07/27 15:44:37  bergsma
 *	Extra arg to mergeData
 *	
 *	Revision 1.7  2003/11/16 20:56:38  bergsma
 *	Implement a["b"] support, equivalent to a.b
 *	
 *	Revision 1.6  2003/04/11 01:54:13  bergsma
 *	Use gpsTempData variable to hold data that could be leaked when
 *	gHyp_instance_error is invoked.
 *	
 *	Revision 1.5  2003/02/17 10:18:26  bergsma
 *	Use gpsTempData to protect against forgetting to free pData memory.
 *	
 *	Revision 1.4  2003/01/12 04:56:14  bergsma
 *	When a method() is not defined, issue a warning rather than an error.
 *	
 *	Revision 1.3  2003/01/09 01:16:32  bergsma
 *	V3.1.0
 *	1. When returning from _main_, set the STATUS variable.
 *	2. Other syntactical errors
 *	
