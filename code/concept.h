...
extern sInstance* gHyp_concept_instantiate ( sConcept *, sInstance*,  char*, char*, sLOGICAL ) ;
...
extern sBYTE gHyp_concept_getSocketObjectType ( sConcept *pConcept, SOCKET socket ) ;
...
extern void gHyp_concept_reassignSecs ( sConcept *pConcept, sWORD id, SOCKET parentFd ) ;
extern void gHyp_concept_reassignPort ( sConcept *pConcept, sWORD id, SOCKET parentFd ) ;
